...
local L = LibStub("AceLocale-3.0"):NewLocale("GatheringTooltip", "esMX")
...
L["Skinning"] = "Desuello"
L["Beast"] = "Bestia"
L["Dragonkin"] = "Dragon"  -- Note: Mexican client doesn't use accent
...
local NL = LibStub("AceLocale-3.0"):NewLocale("GatheringTooltipNodes", "esMX")
...
-- MOP Ores --
NL["Ghost Iron Ore"] = "Hierro fantasma"
