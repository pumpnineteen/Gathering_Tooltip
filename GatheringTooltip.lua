...
local nodeInfo = {
    ...
    [NL["Tin Vein"]] = { skill = L["Mining"], thresholds = { grey = 165, green = 115, yellow = 90 }, requiredSkill = 65 },
    [NL["Silver Vein"]] = { skill = L["Mining"], thresholds = { grey = 175, green = 125, yellow = 100 }, requiredSkill = 75 },
    [NL["Ooze Covered Silver Vein"]] = { skill = L["Mining"], thresholds = { grey = 175, green = 125, yellow = 100 }, requiredSkill = 75 },
    [NL["Iron Deposit"]] = { skill = L["Mining"], thresholds = { grey = 225, green = 175, yellow = 150 }, requiredSkill = 125 },
    [NL["Gold Vein"]] = { skill = L["Mining"], thresholds = { grey = 255, green = 205, yellow = 180 }, requiredSkill = 155 },
    [NL["Ooze Covered Gold Vein"]] = { skill = L["Mining"], thresholds = { grey = 255, green = 205, yellow = 180 }, requiredSkill = 155 },
    [NL["Mithril Deposit"]] = { skill = L["Mining"], thresholds = { grey = 275, green = 225, yellow = 200 }, requiredSkill = 175 },
    [NL["Ooze Covered Mithril Deposit"]] = { skill = L["Mining"], thresholds = { grey = 275, green = 225, yellow = 200 }, requiredSkill = 175 },
    [NL["Dark Iron Deposit"]] = { skill = L["Mining"], thresholds = { grey = 330, green = 280, yellow = 255 }, requiredSkill = 230 },
    [NL["Truesilver Deposit"]] = { skill = L["Mining"], thresholds = { grey = 330, green = 280, yellow = 255 }, requiredSkill = 230 },
    [NL["Ooze Covered Truesilver Deposit"]] = { skill = L["Mining"], thresholds = { grey = 330, green = 280, yellow = 255 }, requiredSkill = 230 },
    [NL["Small Thorium Vein"]] = { skill = L["Mining"], thresholds = { grey = 350, green = 300, yellow = 275 }, requiredSkill = 245 },
    [NL["Rich Thorium Vein"]] = { skill = L["Mining"], thresholds = { grey = 350, green = 300, yellow = 275 }, requiredSkill = 275 },
    [NL["Ooze Covered Thorium Vein"]] = { skill = L["Mining"], thresholds = { grey = 350, green = 300, yellow = 275 }, requiredSkill = 245 },
    [NL["Ooze Covered Rich Thorium Vein"]] = { skill = L["Mining"], thresholds = { grey = 350, green = 300, yellow = 275 }, requiredSkill = 275 },

    -- TBC Mining Nodes --
    [NL["Fel Iron Deposit"]] = { skill = L["Mining"], thresholds = { grey = 350, green = 325, yellow = 275 }, requiredSkill = 300 },
    [NL["Adamantite Deposit"]] = { skill = L["Mining"], thresholds = { grey = 375, green = 350, yellow = 300 }, requiredSkill = 325 },
    [NL["Rich Adamantite Deposit"]] = { skill = L["Mining"], thresholds = { grey = 400, green = 375, yellow = 325 }, requiredSkill = 350 },
    ...
    -- Classic Ores --
    [NL["Copper Ore"]] = { skill = L["Mining"], thresholds = { grey = 100, green = 50, yellow = 25 }, requiredSkill = 1 },
    [NL["Tin Ore"]] = { skill = L["Mining"], thresholds = { grey = 165, green = 115, yellow = 90 }, requiredSkill = 65 },
    [NL["Silver Ore"]] = { skill = L["Mining"], thresholds = { grey = 175, green = 125, yellow = 100 }, requiredSkill = 75 },
    [NL["Iron Ore"]] = { skill = L["Mining"], thresholds = { grey = 225, green = 175, yellow = 150 }, requiredSkill = 125 },
    [NL["Gold Ore"]] = { skill = L["Mining"], thresholds = { grey = 255, green = 205, yellow = 180 }, requiredSkill = 155 },
    [NL["Mithril Ore"]] = { skill = L["Mining"], thresholds = { grey = 275, green = 225, yellow = 200 }, requiredSkill = 175 },
    [NL["Dark Iron Ore"]] = { skill = L["Mining"], thresholds = { grey = 330, green = 280, yellow = 255 }, requiredSkill = 230 },
    [NL["Truesilver Ore"]] = { skill = L["Mining"], thresholds = { grey = 330, green = 280, yellow = 255 }, requiredSkill = 230 },
    [NL["Thorium Ore"]] = { skill = L["Mining"], thresholds = { grey = 350, green = 300, yellow = 275 }, requiredSkill = 250 },

    -- TBC Ores --
    [NL["Fel Iron Ore"]] = { skill = L["Mining"], thresholds = { grey = 350, green = 325, yellow = 275 }, requiredSkill = 300 },
    [NL["Adamantite Ore"]] = { skill = L["Mining"], thresholds = { grey = 375, green = 350, yellow = 300 }, requiredSkill = 325 },
    ...
    -- Classic Herbalism Nodes --
    [NL["Peacebloom"]] = { skill = L["Herbalism"], thresholds = { grey = 100, green = 50, yellow = 25 }, requiredSkill = 1 },
    [NL["Silverleaf"]] = { skill = L["Herbalism"], thresholds = { grey = 100, green = 50, yellow = 25 }, requiredSkill = 1 },
    [NL["Earthroot"]] = { skill = L["Herbalism"], thresholds = { grey = 115, green = 65, yellow = 40 }, requiredSkill = 15 },
    [NL["Mageroyal"]] = { skill = L["Herbalism"], thresholds = { grey = 150, green = 100, yellow = 75 }, requiredSkill = 50 },
    [NL["Briarthorn"]] = { skill = L["Herbalism"], thresholds = { grey = 170, green = 120, yellow = 95 }, requiredSkill = 70 },
    [NL["Stranglekelp"]] = { skill = L["Herbalism"], thresholds = { grey = 185, green = 135, yellow = 110 }, requiredSkill = 85 },
    [NL["Bruiseweed"]] = { skill = L["Herbalism"], thresholds = { grey = 200, green = 150, yellow = 125 }, requiredSkill = 100 },
    [NL["Wild Steelbloom"]] = { skill = L["Herbalism"], thresholds = { grey = 215, green = 165, yellow = 140 }, requiredSkill = 115 },
    [NL["Grave Moss"]] = { skill = L["Herbalism"], thresholds = { grey = 220, green = 170, yellow = 145 }, requiredSkill = 120 },
    [NL["Kingsblood"]] = { skill = L["Herbalism"], thresholds = { grey = 225, green = 175, yellow = 150 }, requiredSkill = 125 },
    [NL["Liferoot"]] = { skill = L["Herbalism"], thresholds = { grey = 250, green = 200, yellow = 175 }, requiredSkill = 150 },
    [NL["Fadeleaf"]] = { skill = L["Herbalism"], thresholds = { grey = 260, green = 210, yellow = 185 }, requiredSkill = 160 },
    [NL["Goldthorn"]] = { skill = L["Herbalism"], thresholds = { grey = 270, green = 220, yellow = 195 }, requiredSkill = 170 },
    [NL["Khadgar's Whisker"]] = { skill = L["Herbalism"], thresholds = { grey = 285, green = 235, yellow = 210 }, requiredSkill = 185 },
    [NL["Wintersbite"]] = { skill = L["Herbalism"], thresholds = { grey = 295, green = 245, yellow = 220 }, requiredSkill = 195 },
    [NL["Firebloom"]] = { skill = L["Herbalism"], thresholds = { grey = 305, green = 255, yellow = 230 }, requiredSkill = 205 },
    [NL["Purple Lotus"]] = { skill = L["Herbalism"], thresholds = { grey = 305, green = 255, yellow = 235 }, requiredSkill = 210},
    [NL["Arthas' Tears"]] = { skill = L["Herbalism"], thresholds = { grey = 320, green = 270, yellow = 245 }, requiredSkill = 220 },
    [NL["Sungrass"]] = { skill = L["Herbalism"], thresholds = { grey = 330, green = 280, yellow = 255 }, requiredSkill = 230 },
    [NL["Blindweed"]] = { skill = L["Herbalism"], thresholds = { grey = 335, green = 285, yellow = 260 }, requiredSkill = 235 },
    [NL["Ghost Mushroom"]] = { skill = L["Herbalism"], thresholds = { grey = 345, green = 295, yellow = 270 }, requiredSkill = 245 },
    [NL["Gromsblood"]] = { skill = L["Herbalism"], thresholds = { grey = 350, green = 300, yellow = 275 }, requiredSkill = 250 },
    [NL["Golden Sansam"]] = { skill = L["Herbalism"], thresholds = { grey = 360, green = 310, yellow = 285 }, requiredSkill = 260 },
    [NL["Dreamfoil"]] = { skill = L["Herbalism"], thresholds = { grey = 370, green = 320, yellow = 295 }, requiredSkill = 270 },
    [NL["Mountain Silversage"]] = { skill = L["Herbalism"], thresholds = { grey = 380, green = 330, yellow = 305 }, requiredSkill = 280 },
    [NL["Plaguebloom"]] = { skill = L["Herbalism"], thresholds = { grey = 385, green = 335, yellow = 310 }, requiredSkill = 285 },
    [NL["Icecap"]] = { skill = L["Herbalism"], thresholds = { grey = 390, green = 340, yellow = 315 }, requiredSkill = 290 },
    [NL["Black Lotus"]] = { skill = L["Herbalism"], thresholds = { grey = 400, green = 350, yellow = 325}, requiredSkill = 300 },
